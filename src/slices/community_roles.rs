...
use twilight_model::gateway::payload::incoming::{
    GuildCreate, MessageDelete, MessageDeleteBulk, ReactionAdd, ReactionRemove,
};

use crate::{
    context::Context,
    events::{guild_create, message_delete, reaction_add, reaction_remove},
    slices::registry::FeatureSlice,
};

pub struct CommunityRolesSlice;

#[async_trait]
impl FeatureSlice for CommunityRolesSlice {
